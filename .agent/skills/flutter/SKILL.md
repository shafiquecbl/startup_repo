...
## 13. Adding a New Feature — Dummy-Data-First Workflow
...
### 13.1 Feature Directory Scaffold
...
### 13.4 API Specification Document
...
**Purpose:** Fetch detailed info for a specific food item.

**Request:**
- Path param: `id` (String) — the food item ID
...
```json
{
  ...
  "name": "Smash Burger",
  "price": 32.0,
  "full_description": "Double smashed beef patties...",
  "ingredients": ["Beef", "Cheddar", ...],
  "calories": 680,
  "sizes": [{"id": "s1", "name": "Regular", "price_adjustment": 0}],
  "addon_groups": [
    {
      "id": "g1",
      ...
      "is_required": true,
      "max_selections": 1,
      "addons": [{"id": "a1", "name": "Classic Brioche", "price": 0}]
    }
  ]
}
```
...
| 2026-02-17 | Feature workflow | Added Dummy-Data-First workflow (Section 13) — build complete features with dummy data, generate API spec docs for backend devs |
